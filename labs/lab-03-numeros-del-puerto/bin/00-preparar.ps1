...
# ─────────────────────────────────────────────────────────────────────────
#  Preparador del Lab 03 (Windows / PowerShell)
...
Write-Host "Preparando el Lab 03 - Los numeros del puerto" -ForegroundColor Cyan
...
Write-Host "[INFO] numpy y pandas pesan unos MB; si tienes proxy/antivirus, ten paciencia." -ForegroundColor Cyan
uv sync
